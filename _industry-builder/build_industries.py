          ...
          <div class="offer-card reveal">
            ...
            <div class="offer-top">
              <span class="offer-badge">
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2l2.7 6.8L22 11l-7.3 2.2L12 22l-2.7-8.8L2 11l7.3-2.2z" fill="currentColor"/></svg>
                Everything included &middot; one flat price
              </span>
              <p class="offer-price">
                <span class="offer-currency">$</span><span class="offer-num">3,500</span><span class="offer-period">/ month</span>
              </p>
              <p class="offer-sub">All-inclusive. Cancel anytime &mdash; no contract, no setup fee.</p>
              <a href="{CALENDLY}" target="_blank" rel="noreferrer" class="button button-electric button-lg offer-cta">
                <span>Book a free 15-min call</span>
                <svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 8h10M8 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="square"/></svg>
              </a>
              <p class="offer-fineprint">First build live in ~2 weeks &middot; You own everything we build</p>
            </div>
            ...
            <div class="offer-includes">
              ...
              <ul class="offer-grid">
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>Unlimited AI agents</strong><span>Build as many as your business needs &mdash; no cap, ever</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>Unlimited revisions</strong><span>We tune every build until it's exactly right</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>Everything done for you</strong><span>We build it start to finish &mdash; you never touch code</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>Ongoing monitoring &amp; maintenance</strong><span>If a tool drifts, we catch it and fix it</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>New automations as you grow</strong><span>Your needs change &mdash; your tools keep up</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>A real person on call</strong><span>A direct line to the team, not a ticket queue</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>You own everything</strong><span>Code, accounts, keys &mdash; all handed to you</span></div>
                </li>
                <li>
                  <span class="offer-check" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12l4 4L19 6" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                  <div><strong>Cancel anytime</strong><span>Month to month &mdash; no long-term contract</span></div>
                </li>
              </ul>
            </div>
          </div>
